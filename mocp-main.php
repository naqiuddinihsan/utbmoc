...
<!--
        <li>
            <div class="moc-hint">
                <h4>Instructions</h4>
                <ul>
                    <li>• Please understand each step thoroughly before you proceed.</li>
                    <li>• Please refer to the map attached for your reference.</li>
                    <li><a href="/img/utbmoc_layout.png" >CLICK HERE FOR MAP</a></li>
                    <li>• Any inquiries, do not hesitate to approach any working committees around the campus.</li>
                </ul>
            </div>
        </li>
-->
